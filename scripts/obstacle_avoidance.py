...
class ObstacleAvoidance:
    """
    Obstacle Avoidance class for Obstacle Avoidance and Wall Following
    """

    def __init__(self, node_name):
        """
        Init function for ObstacleAvoidance class
        """
        ...
        # Publisher which will publish obstacle avoidance decision to
        # '/obstacle_avoidance' topic.
    ...
    def make_decision(self):
        ...
        # Min helps us find the gap with the farthest next obstacle
        # and tells us how far the closest object is.
        #
        # Max helps us find the gap with the farthest distance and
        # tells us how far that object is.
        ...
        #
        # Too high of an angular velocity will miss certain windows
        # of opportunity
        # .5 is too high
        # .42 is too low
        #
        # Too low of an angular velocity and we won't be able to
        # perform the maneuveur
        if self.work_mode != 'simulation':

            # Changing the higher end will make the bot decide
            # which way to look for an opening
            if 0.1 <= ahead_min <= 0.6 or \
                    0.1 <= left_min <= 0.2 or \
                    0.1 <= right_min <= 0.2:
